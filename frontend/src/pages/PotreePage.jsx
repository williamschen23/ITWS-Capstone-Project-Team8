  ...
  return (
    <div className="h-[calc(100vh-4rem)] overflow-hidden app-surface text-foreground">
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-6 h-full">
        ...
        <div className="mx-auto w-20 h-20 rounded-2xl bg-muted flex items-center justify-center shadow">
        ...
        <div>
          ...
          <p className="text-lg text-(--foreground)/70">To be implemented</p>
        </div>
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-muted border border-neutral-200 text-sm text-(--foreground)/60">
